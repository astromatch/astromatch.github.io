...
function Onboarding(){
  ...
  async function submitBirthProfile(e:FormEvent<HTMLFormElement>){
    ...
    try{
      ...
      nav(`/profile/chart/${created.profile.id}`,{replace:true});
    }catch(error){
